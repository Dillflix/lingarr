...
public class LingarrDbContext : DbContext
{
    ...
    public DbSet<ResegmentationBenchmarkSample> ResegmentationBenchmarkSamples { get; set; }
    public DbSet<SourceUnitBenchmarkSample> SourceUnitBenchmarkSamples { get; set; }
