...
public static class ServiceCollectionExtensions
{
    ...
    private static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<SourceUnitDetectionService>();
        builder.Services.AddScoped<ISourceUnitDetectionService, CapturingSourceUnitDetectionService>();
